...
class CyberInvestigator(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Cyber Investigator Toolkit (Cross-Platform)")
    ...
    def run_whois(self):
        ...
        if shutil.which("whois"):
            ...
            result = "Error: 'whois' tool not found. Install it for your OS."
    ...
    def run_usb_history(self):
        if self.os_type == "Windows":
            ...
            if shutil.which("lsusb"):
                ...
                result = "Error: 'lsusb' not found. Install with 'sudo apt install usbutils'."
        else:
            result = "USB History is only supported on Windows and Linux in this tool."
    ...
    def run_volatility(self):
        if shutil.which("volatility"):
            if self.os_type == "Windows":
                ...
                result = self.run_command("volatility -f memdump.raw --profile=LinuxUbuntu_18_4x64 pslist")
        else:
    ...
    def run_tshark(self):
        if shutil.which("tshark"):
            ...
            result = "Error: 'tshark' not found. Install Wireshark/tshark for your OS."
    ...
    def run_pdf_exploit(self):
        ...
        if shutil.which("msfconsole"):
            if self.os_type == "Windows" or self.os_type == "Linux":
                ...
                result = "PDF exploit only supported on Windows/Linux."
        else:
            result = "Error: 'msfconsole' (Metasploit) not found. Install for your OS."
